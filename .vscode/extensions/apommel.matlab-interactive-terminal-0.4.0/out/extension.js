...
function activate(context) {
    ...
    const openMatlabTerminal = () => {
        ...
        if (correctSetup) {
            const opts = Object.assign({}, terminalLaunchOptions);
    ...
    const matlabTerminalProfile = {
        provideTerminalProfile() {
            let terminalPath = path.join(scriptDir, "ml_terminal.py");
            return {
                options: Object.assign(Object.assign({}, terminalLaunchOptions), { shellArgs: [terminalPath] })
            };
        }
    };
