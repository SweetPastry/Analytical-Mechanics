...
exports.ClangCompletionItemProvider = exports.optionalArgumentRightRe = exports.optionalArgumentLeftRe = exports.argumentTypeRe = exports.returnTypeRe = exports.descriptionRe = exports.completionRe = void 0;
...
class ClangCompletionItemProvider {
    ...
    parseCompletionItem(line) {
        ...
        const match = description.match(exports.descriptionRe);
        if (match == null) {
            return;
        }
