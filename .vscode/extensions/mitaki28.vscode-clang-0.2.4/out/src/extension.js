...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("clang.trustWorkspace", () => {
        state.getWorkspaceState().updateWorkspaceIsTrusted(true);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("clang.untrustWorkspace", () => {
        state.getWorkspaceState().updateWorkspaceIsTrusted(false);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("clang.resetWorkspaceState", () => {
