...
$$
\begin{align*}
	E&= \dfrac{1}{2}m \dfrac{\mathrm{d}x^2+\mathrm{d}y^2}{\mathrm{d}t^2}+mgy
	\\\\
	&= \dfrac{1}{2}m \dfrac{\mathrm{d}x^2+{f^{\prime}}^2\left( x \right) \mathrm{d}x^2}{\mathrm{d}t^2}+mgf\left( x \right) 
	\\\\
	&= \dfrac{1}{2}m\left( 1+{f^{\prime}}^2\left( x \right) \right) \dot{x}^2+ \dfrac{1}{2}2mg \dfrac{f\left( x \right)}{x^2}x^2.
\end{align*}
$$
...
$$
 \dfrac{f(x)/x^2}{1+{f^{\prime}}^2\left( x \right)}=C.
$$
...
$$
N=\lambda lg+\lambda v \dfrac{\mathrm{d}l}{\mathrm{d}t}.
$$
...
若希望写成时间的函数, 代入 $l= \dfrac{1}{2}gt^2$ 即可:\

$$
N= \dfrac{3}{2}\lambda g^2t.
$$
...
$$
B=\rho x\left( g+ \dfrac{\mathrm{d}v}{\mathrm{d}t} \right) +\rho v\mathrm{d}t\cdot v \dfrac{1}{\mathrm{d}t}=\rho x\left( g+ \dfrac{\mathrm{d}v}{\mathrm{d}t} \right) +\rho v^2.
$$

这个方程的解为

$$
v^2=- \dfrac{1}{3}gx+ \dfrac{2}{3} \dfrac{B}{\rho}.
$$
