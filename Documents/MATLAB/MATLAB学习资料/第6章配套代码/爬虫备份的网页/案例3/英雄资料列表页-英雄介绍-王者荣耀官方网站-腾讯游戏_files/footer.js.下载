...
var pvpFooter = (function(){
	...
	util.addFooterCSS = function(){
		var footerCSS = '';
			...
			footerCSS += '.footer-wrap .foot_lefts{display: block;float:none;height: 66px;padding-bottom:10px;margin-bottom:12px;border-bottom:2px solid #d4d4d4;}';
			...
			footerCSS += '.footer-wrap .copyright_zh{float:right;padding-top:6px;}';
	...
	util.addFooterHTML = function(){
		var footerHTML = '';
			...
			footerHTML += '    <a target="_blank" href="//timi.qq.com/" title="天美工作室群" class="foot_left logo1">timi</a>';
	...
	init = function(){
		util.addFooterCSS();
		util.addFooterHTML();
		fn.jsLoader("//game.gtimg.cn/images/js/2018foot/foot.js", function(){
			!window.setPrivateLink && setTimeout(function(){
				window.GameFooter && window.GameFooter.addLinks({
						service: {link: 'https://game.qq.com/tencent_other_contract.shtml'},
						private: {text: '王者荣耀隐私保护指引',link: 'https://rule.tencent.com/rule/preview/d277ee20-2709-4cd5-882b-cbd485753346'},
