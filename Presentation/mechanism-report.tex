...
\begin{document}
    ...
    \frame{\sectionpage}
        ...
        \begin{frame}{Raw Lagrange Equation}
            ...
            \only<3>{\begin{equation}
                \frac{\mathrm{d}}{\mathrm{d}t}\frac{\partial T}{\partial \dot{q}^{\tikzmarknode{k}{\hlmath{red}{\scriptstyle k}}}}-\frac{\partial T}{\partial q^k}+\frac{\partial V}{\partial q^k}=Q_{k}^{\left( \mathrm{nc} \right)}.
            ...
            \only<4>{\begin{equation}
                \frac{\mathrm{d}}{\mathrm{d}t}\frac{\partial T}{\partial \dot{q}^k}-\frac{\partial T}{\partial q^k}+\frac{\partial V}{\partial q^k}=Q_{k}^{\left(\tikzmarknode{nc}{\hlmath{red}{\scriptstyle \mathrm{nc}}} \right)}.
            \end{equation}\begin{tikzpicture}[overlay, remember picture, >=stealth, nodes={align=left, inner ysep=2pt}, <-]
        ...
        \begin{frame}{Rayleigh's Disppative Protential}
            ...
            \only<3>{\begin{equation}
                F_{ai}=-K_{i \tikzmarknode{j1}{\hlmath{red}{\scriptstyle j}}}v_{a}^{\tikzmarknode{j2}{\hlmath{red}{\scriptstyle j}}},
        ...
        \begin{frame}{Lagrange-Rayleigh Equation}
            ...
            \only<3>{\begin{equation}
                \frac{\mathrm{d}}{\mathrm{d}t} \frac{\partial T}{\partial \dot{q}^k}-\frac{\partial T}{\partial q^k}+\frac{\partial V}{\partial q^k}=-\frac{\partial R}{\partial \dot{q}^k}+Q_{k}^{\left( \tikzmarknode{nc}{\hlmath{red}{\scriptstyle\mathrm{nc'}}}  \right)}.
            \end{equation}\begin{tikzpicture}[overlay, remember picture, >=stealth, nodes={align=left, inner ysep=2pt}, <-]
    ...
    \begin{frame}{Generalized Rayleigh Protential}
        ...
        \only<4>{and let $\mathbf{v}_{a}^{\left( \mathrm{r} \right)}=\mathbf{v}_{\tikzmarknode{a}{\hlmath{red}{\scriptstyle a}}}-\mathbf{v}_b$. Here we allow the 2 surfaces move respectively, with consistent the same normal.\begin{tikzpicture}[overlay, remember picture, >=stealth, nodes={align=left, inner ysep=2pt}, <-]
        ...
        \end{tikzpicture}}
        \only<5>{and let $\mathbf{v}_{a}^{\left( \mathrm{r} \right)}=\mathbf{v}_a-\mathbf{v}_{\tikzmarknode{b}{\hlmath{red}{\scriptstyle b}}}$. Here we allow the 2 surfaces move respectively, with consistent the same normal.\begin{tikzpicture}[overlay, remember picture, >=stealth, nodes={align=left, inner ysep=2pt}, <-]
